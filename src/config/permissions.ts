...
export const rolePermissions: Record<RoleKey, string[]> = {
  ...
  tier1: [
    ...
    'product-purchase:view', 'product-purchase:create', 'product-purchase:export', 'contracts:view', 'contracts:export',
  ...
  tier2: [
    ...
    'materials:view', 'materials:create', 'product-purchase:view', 'product-purchase:create', 'product-purchase:export', 'contracts:view', 'contracts:export', 'material-catalog:view', 'couriers:view',
  ...
  custom: [
    ...
    'complaints:*', 'materials:view', 'materials:approve', 'materials:reject', 'materials:ship', 'materials:start-production', 'materials:complete-production', 'materials:finance-confirm', 'materials:purchase-ship', 'materials:confirm-purchase-receipt',
    'product-purchase:view', 'product-purchase:export', 'contracts:view', 'contracts:export',
